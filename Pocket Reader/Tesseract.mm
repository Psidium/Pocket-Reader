...
- (id)initWithDataPath:(NSString *)dataPath language:(NSString *)language {
    ...
    if (self) {
        _dataPath = dataPath;
        _language = language;
        NSLog(@"dataPath no inicio: %@", dataPath);
...
- (void)copyDataToDocumentsDirectory {
    ...
    NSLog([bundlePath stringByAppendingString:@"/"]);
